...
**Use direct string replacement for XML editing. Do not write Python scripts.** Scripts introduce unnecessary complexity. Direct edits show exactly what is being replaced.
